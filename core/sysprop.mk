...
ifeq (,$(strip $(BUILD_FINGERPRINT)))
  ...
  ifneq ($(strip $(OVERRIDE_TARGET_PRODUCT)),)
    BUILD_FINGERPRINT := $(PRODUCT_BRAND)/$(OVERRIDE_TARGET_PRODUCT)/$(OVERRIDE_TARGET_DEVICE):$(OVERRIDE_PLATFORM_VERSION)/$(BUILD_ID)/$(BF_BUILD_NUMBER):$(TARGET_BUILD_VARIANT)/$(BUILD_VERSION_TAGS)
  else
